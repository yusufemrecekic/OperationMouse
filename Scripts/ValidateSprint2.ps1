...
$validationScript = Join-Path $PSScriptRoot "Editor\validate_sprint2_carry.py"
...
if ($LASTEXITCODE -ne 0) {
    throw "Sprint 2 validation failed with exit code $LASTEXITCODE."
}

Write-Host "Sprint 2 automated validation PASSED."
