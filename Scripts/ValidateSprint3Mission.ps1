...
$validationScript = Join-Path $PSScriptRoot "Editor\validate_sprint3_mission.py"
...
if ($LASTEXITCODE -ne 0) {
    throw "Sprint 3 Mission validation failed with exit code $LASTEXITCODE."
}

Write-Host "Sprint 3 Mission automated validation PASSED."
