...
$configurationScript = Join-Path $PSScriptRoot "Editor\configure_sprint3_mission_test.py"
...
if ($LASTEXITCODE -ne 0) {
    throw "Sprint 3 Mission test-map configuration failed with exit code $LASTEXITCODE."
}

Write-Host "Sprint 3 Mission test map configured."
