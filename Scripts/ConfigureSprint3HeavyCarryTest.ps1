...
$configurationScript = Join-Path $PSScriptRoot "Editor\configure_sprint3_heavy_carry_test.py"
...
if ($LASTEXITCODE -ne 0) {
    throw "Sprint 3 Heavy Carry test-map configuration failed with exit code $LASTEXITCODE."
}

Write-Host "Sprint 3 Heavy Carry test map configured."
